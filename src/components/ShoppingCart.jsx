...
const ShoppingCart = () => {
    ...
    useEffect(() => {
        ...
        const price = inCartItems.reduce((accumlator, item) => {
    ...
    return (
        ...
        {cartItems.length !== 0 && (
            <div className={`w-[300px] h-screen bg-gray-200 fixed top-0 z-30 border-l-4 border-red-200 rounded-tl-lg ${isOpen ? "right-0" : "-right-[300px]"}`}>
                <div className="w-full h-16 bg-white absolute left-0 top-0 z-10 grid place-items-center border-lg">
                ...
                >
                    ...
                    <span className="w-6 h-6 bg-pink-400 absolute -bottom-4 -left-2 place-items-center border-gray-300 border rounded-full text-sm text-white">
                ...
                <div className="w-full h-20 bg-white absolute bottom-0 left-0 z-10 grid place-items-center border rounded-lg">
                    ...
                    <button className="rounded-md bg-blue-300 px-2 text-white hover:bg-blue-400 transition-colours">Buy now</button>
                </div>
            </div>
        )}
